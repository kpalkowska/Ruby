...
RSpec.describe 'matrix_multiply.rb' do
  describe "#Matrix_multiply" do
    ...
    it "should be defined if result is matrix with the same number of rows and columns" do
      matrix1=[[1,2,3],[4,5,6]]
      matrix2=[[1,2],[3,4],[5,6]]
      expect(multi(2,3,3,2,matrix1,matrix2)).to eq([[22,28],[49,64]])
    end

    it "should be defined if number of columns in matrix1 equals number of rows in matrix2" do
    ...
    it "should be defined if result is matrix with not equal number of rows and columns" do
